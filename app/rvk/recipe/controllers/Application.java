...
import rvk.recipe.controllers.Application;
import play.Routes;
...
public class Application extends Controller {
	...
	@Restrict({@Group(UserRole.USER_ROLE_NAME),@Group(UserRole.PRIVILE_ROLE_NAME)})
	public static Result restricted() {
		final User localUser = getLocalUser(session());
		return ok(restricted.render(localUser));
	}

	@Restrict({@Group(UserRole.USER_ROLE_NAME),@Group(UserRole.PRIVILE_ROLE_NAME),@Group(UserRole.ADMIN_ROLE_NAME)})
	...
	public static Result jsRoutes() {
		return ok(
				Routes.javascriptRouter("jsRoutes",
						rvk.recipe.controllers.routes.javascript.Signup.forgotPassword()))
				.as("text/javascript");
	}
